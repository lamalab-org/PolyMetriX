    ...
    for index, row in df.iterrows():
        ...
        try:
            ...
            if sidechains:
                ...
                df.loc[index, "mean_length_sc"] = sum(sidechain_lengths) / len(
                    sidechain_lengths
                )
            else:
                df.loc[index, "len_sc"] = ""
            ...
            if backbones:
                ...
                df.loc[index, "mean_length_bb"] = sum(backbone_lengths) / len(
                    backbone_lengths
                )
            else:
                df.loc[index, "len_bb"] = ""
...
if __name__ == "__main__":
    ...
    output_file = Path.home().joinpath(
        "PolyMetriX", "data", "Polymer_Tg_descriptors_dummy.csv"
    )
